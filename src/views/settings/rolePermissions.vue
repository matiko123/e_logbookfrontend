...
<script setup>
    ...
    useMeta({ title: 'Role-Permissions' });
   ...
   const getAvailablePermissions = (role) => {
    ...
    const deleteRolePermission = (roleId,permissionId,roleIndex, permissionIndex) => {
        ...
        axiosInstance.delete(`/role-permissions/${roleId}/${permissionId}`)
            .then((response) => {
    ...
    const registerRolePermission = (roleId, permissionId) => {
        ...
        axiosInstance
            .post('/role-permissions', itemData)
            .then((response) => {
            ...
            .catch((error) => {
                showError(error.message);
                console.error("Error registering role  Permission:", error);
            });
    }
